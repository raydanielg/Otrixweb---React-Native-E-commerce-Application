...
function AddAdressComponent(props) {
    ...
    const [formData, setData] = React.useState({ name: null, country: null, state: null, city: null, address1: null, address2: null, postcode: null, submited: false });

    const { name, country, city, address1, address2, state, postcode, submited } = formData;
